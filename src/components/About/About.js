				...
				<Fade duration={500}>
					<div className="container my-5">
						<Alert variant="success">
							...
							<h4 className="text-center">
								Elevate helps you build your confidence in solving any coding <br /> related question and helps you
					...
					<div className="container my-5">
						<h2 className="text-center">
							<a href="https://github.com/Chethanpatel/Elevate">Elevate</a> is your personal web-based progress tracker based on <br></br>
							<i>
								<a
							...
							by{" "}
							<b>
								<a href="https://drive.google.com/file/d/1FMdN_OCfOI0iAeDlqswCiC2DZzD4nPsb/view" target="_blank" rel="noopener noreferrer">
									Popular DSA Sheets
								</a>
							</b>{" "}
						...
						<h4 className="text-center my-5">
							Project by{" "}
							<a href="https://www.linkedin.com/in/chethanpatelpn/" target="_blank" rel="noopener noreferrer">
								Elevate Team
							</a>{" "}
